...
var AuthenticationContext = (function () {
     ...
     *  @property {string} redirectUri - Endpoint at which you expect to receive tokens. Set this value only if you want to redirect user to a page other than the login start page after successful authentication.
     *  @property {string} instance - Azure Active Directory Instance (default:https://login.microsoftonline.com/).
     *  @property {Array} endpoints - Collection of {Endpoint-ResourceId} used for autmatically attaching tokens in webApi calls.
     *  @property {Boolean} popUp - Set this to true to enable login in a popup winodow instead of a full redirect.
    ...
    /**
     * Gets initial Idtoken for the app's backend and saves it in the cache.
     */
    ...
    */
    ...
    /**
     * If multiple requests for acquireToken are made for the same resource, we send only the first request and register the callbacks for all subsequent requests.
     * When we process the response from AAD, this method calls all the callbacks with the error/token.
     * @returns {User} user object
     */
    ...
    /**
     * Acquires token from cache if not expired and available. Acquires token from iframe if expired.
     * @param {string}   resource  ResourceUri identifying the target resource
     * @param {requestCallback} callback -  The callback that contains the token or error
     */
     ...
     * After logout, it will redirect to post_logout page if specified.
     */
    ...
    /**
     * Parameters object created from the response received from AAD.
     *  @class Parameters
     *  @property {string} id_token - id_token of the user.
     *  @property {string} session_state - state identifying the user's session.
     *  @property {string} state - unique guid used to match the response with the request.
     */

    /**
     * Request info object created from the response received from AAD.
     *  @class RequestInfo
     *  @property {Parameters} parameters - object comprising of id_token/error, session_state and state.
     *  @property {requestType} requestType - either LOGIN, RENEW_TOKEN or UNKNOWN.
    ...
    /**
     * Saves token from hash that is received from the redirect response from AAD.
     */
    ...
    /**
     * Calls the callbacks registered on the config object with the token/error and resets the window location to login start page in case of full redirect.
     * @ignore
     */
    ...
    /**
     * Generates the parameters for the authorization endpoint URL.
     * @ignore
     */
    ...
    /**
     * Parses id token to generate the following keys: - id_token/error, session_state and state
     * @ignore
     */
    ...
    /**
     * Creates a copy of the config object passed to the constructor.
     * @ignore
     */
    ...
    /**
     * Checks the Logging Level and constructs the Log message.
     * @ignore
     */
    ...
    /**
     * Logs messages to the console window of the browser when Logging Level is set to 0.
     * @ignore
     */
    ...
    /**
     * Logs messages to the console window of the browser when Logging Level is set to 1.
     * @ignore
     */
    ...
    /**
     * Logs messages to the console window of the browser when Logging Level is set to 2.
     * @ignore
     */
    ...
    /**
     * Logs messages to the console window of the browser when Logging Level is set to 3.
     * @ignore
     */
