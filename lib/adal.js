...
var AuthenticationContext = (function () {
     ...
     *  @property {string} redirectUri - Endpoint at which you expect to receive tokens. Set this value only if you want to redirect user to a page other than the login start page..
   ...
   */
    ...
    */
     ...
     * After logout, it will redirect to post_logout page if .
     */
    ...
    */
     ...
     * @returns {object} An object containing the login response comprising of the keys - parameters, requestType, stateMatch, stateResponse and valid.
     */
    ...
    /**
     * Contructs the authorization endpoint URL and returns it.
     * @ignore
     */
